 ...
 *
 * This project also allows LSS fastscan while a valid node ID is already active, so configured nodes remain
 * discoverable by their LSS identity without first invalidating node ID.
 *
