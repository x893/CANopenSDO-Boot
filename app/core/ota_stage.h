 ...
 */
#define OTA_FLASH_BASE_ADDR         FLASH_BASE
#define OTA_KERNEL_REGION_SIZE      0x00020000U
#define OTA_STAGE_REGION_SIZE       0x00020000U
#define OTA_STAGE_REGION_START      (OTA_FLASH_BASE_ADDR    + OTA_KERNEL_REGION_SIZE)
